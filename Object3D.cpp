...
size_t Object3D::activeTexInc() { return m_mesh->activeTexInc(); }

size_t Object3D::activeTexDec() { return m_mesh->activeTexDec(); }
size_t Object3D::activeTexRand() { return m_mesh-> activeTexRand(); }
size_t Object3D::getActiveTextureIndex() { return m_mesh->getActiveTextureIndex(); }
void Object3D::addTexture(const StbImage &texture) { m_mesh->addTexture(texture); }
